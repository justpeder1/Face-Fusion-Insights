    ...
    <footer className="py-10 border-t border-white/10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4 text-gradient">FaceFusion Insights</h3>
            <p className="text-sm text-muted-foreground">
              Advanced facial analysis technology to understand ethnicity, ancestry, and unique traits.
            </p>
          </div>
          <div>
        ...
        <div className="mt-10 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} FaceFusion Insights. All rights reserved.
          </p>
